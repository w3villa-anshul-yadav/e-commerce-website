  ...
  `;
     ...
     `;
      ...
      function handlePagination(resultArr) {
        document
          .getElementById("paginationHandler")
      ...
      function showHIdeNav() {
        let saleContainer =
          document.getElementsByClassName("sale-container")[0];
      ...
      document
        .getElementById("login-logout-click")
        .addEventListener("click", () => {
